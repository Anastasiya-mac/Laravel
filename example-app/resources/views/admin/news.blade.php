...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('.adminnews.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('.adminnews.edit', ['news' => $n['id']]) }}" style="font-size: 12px;">редактирование</a> &nbsp;
